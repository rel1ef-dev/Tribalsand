...
<head>
    ...
    <title>TribalSand | My Amani Gallery</title>
    <meta name="description" content="Stay at Amani Villa by TribalSand – a private beachfront villa offering luxury accommodation, stunning ocean views, and personalized services for an unforgettable escape.">
    <link rel="icon" href="images/favicon.png">
    <!-- Canonical -->
    <link rel="canonical" href="https://tribalsand.com/my-amani-gallery" />
    ...
    <style>
        ...
        .slideshow-image {
            ...
            width: 100%;
            height: 100%;
            background-image: url('images/Copy-of-October-28-2021-6-PM.07.49-2622-HDR-min.jpg');
        ...
        <div class="container content-container">
            <div class="row justify-content-center">
                <div class="col-12 col-md-10 col-lg-8">
                    <h1 class="main-title">My Amani Gallery</h1>
                    <a href="my-amani.php" class="btn book-btn px-4 py-2" style="background-color:#C9A96A; border-radius: 0;">
